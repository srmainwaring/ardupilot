...
{
    // always allow arming from the ground station or scripting or dds
    if (method == AP_Arming::Method::MAVLINK || method == AP_Arming::Method::SCRIPTING || method == AP_Arming::Method::DDS) {
        return true;
    }
