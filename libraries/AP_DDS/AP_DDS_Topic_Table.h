...
AP_DDS_Client::Topic_table* AP_DDS_Client::new_topic_table() {
    
    AP_DDS_Client::Topic_table tmp_topics[] = {
      {
    ...
    auto n = sizeof(tmp_topics) / sizeof(AP_DDS_Client::Topic_table);

    AP_DDS_Client::Topic_table* ptr = new AP_DDS_Client::Topic_table[n]; 
    memcpy(ptr, tmp_topics, n);
