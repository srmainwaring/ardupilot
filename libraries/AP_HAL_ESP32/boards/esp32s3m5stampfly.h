...
// IMU
#define HAL_INS_PROBE_LIST PROBE_IMU_SPI(BMI270, "bmi270", ROTATION_ROLL_180_YAW_270)
...
// SD card
// TODO: cannot currently use the same SPI bus as other peripherals.
#define HAL_ESP32_SDCARD 1
#define HAL_ESP32_SDSPI \
    {.host=SPI3_HOST, .dma_ch=SPI_DMA_CH_AUTO, .mosi=GPIO_NUM_16, .miso=GPIO_NUM_17, .sclk=GPIO_NUM_18, .cs=GPIO_NUM_12}
...
#define HAL_LOGGING_STACK_SIZE 4096     // default is 1580
