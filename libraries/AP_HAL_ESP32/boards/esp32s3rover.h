...
#define HAL_ESP32_BOARD_NAME "esp3s3rover"
...
#define CONFIG_HAL_BOARD_SUBTYPE HAL_BOARD_SUBTYPE_ESP32_S3ROVER
...
#define HAL_ESP32_I2C_BUSES \
    {.port=I2C_NUM_0, .sda=GPIO_NUM_8, .scl=GPIO_NUM_3, .speed=400*KHZ, .internal=true, .soft=true}

//SPI Buses
#define HAL_ESP32_SPI_BUSES \
    {.host=SPI2_HOST, .dma_ch=SPI_DMA_CH_AUTO, .mosi=GPIO_NUM_37, .miso=GPIO_NUM_35, .sclk=GPIO_NUM_36}

//SPI Devices
#define HAL_ESP32_SPI_DEVICES \
    {.name= "mpu9250", .bus=0, .device=0, .cs=GPIO_NUM_38, .mode=0, .lspeed=2*MHZ, .hspeed=8*MHZ}
...
//RCOUT
#define HAL_ESP32_RCOUT {GPIO_NUM_4, GPIO_NUM_5, GPIO_NUM_6, GPIO_NUM_7}
...
#define HAL_ESP32_UART_DEVICES \
    ...
    {.port=UART_NUM_2, .rx=GPIO_NUM_2, .tx=GPIO_NUM_1}
...
//     {.host=SPI3_HOST, .dma_ch=SPI_DMA_CH_AUTO, .mosi=GPIO_NUM_13, .miso=GPIO_NUM_11, .sclk=GPIO_NUM_12, .cs=GPIO_NUM_10}
