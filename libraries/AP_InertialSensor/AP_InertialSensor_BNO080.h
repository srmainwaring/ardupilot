#pragma once
/*
  driver for the Hillcrest Labs BNO080 IMU:
 */
...
class AP_BNO080_AuxiliaryBus;
class AP_BNO080_AuxiliaryBusSlave;

class AP_InertialSensor_BNO080 : public AP_InertialSensor_Backend
{
    friend AP_BNO080_AuxiliaryBus;
    friend AP_BNO080_AuxiliaryBusSlave;

public:
    virtual ~AP_InertialSensor_BNO080();
    static AP_InertialSensor_BNO080 &from(AP_InertialSensor_Backend &backend) {
        return static_cast<AP_InertialSensor_BNO080&>(backend);
    }
...
private:
    ...
    AP_BNO080_AuxiliaryBus *_auxiliary_bus;
...
class AP_BNO080_AuxiliaryBusSlave : public AuxiliaryBusSlave
{
    friend class AP_BNO080_AuxiliaryBus;
...
protected:
    AP_BNO080_AuxiliaryBusSlave(AuxiliaryBus &bus, uint8_t addr, uint8_t instance);
...
class AP_BNO080_AuxiliaryBus : public AuxiliaryBus
{
    friend class AP_InertialSensor_BNO080;
...
protected:
    AP_BNO080_AuxiliaryBus(AP_InertialSensor_BNO080 &backend, uint32_t devid);
